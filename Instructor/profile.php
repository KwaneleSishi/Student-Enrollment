...
$stmt->bindParam(':user_id', $user_id, PDO::PARAM_INT);
$stmt->execute();
$courses_taught = $stmt->fetchColumn();

// Fetch total enrolled students across the instructor's courses
$stmt = $conn->prepare("
    SELECT SUM(capacity) FROM courses WHERE instructor_id = :user_id
");
$stmt->bindParam(':user_id', $user_id, PDO::PARAM_INT);
$stmt->execute();
            ...
            <div class="profile-container">
                <div class="profile-sidebar">
                    ...
                    <div class="profile-stats">
                        <div class="stat-item"><span class="stat-label">Courses Taught</span><span class="stat-value"><?php echo $courses_taught; ?></span></div>
                        <div class="stat-item"><span class="stat-label">Total Enrolled Students</span><span class="stat-value"><?php echo $total_enrolled; ?></span></div>
                    </div>
                </div>
